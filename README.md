...
⚡16+ лет опыта в заказной web-разработке. Участвовала в полном цикле создания web-проектов: требования, вёрстка, сборка на CMS, релиз, поддержка, тестирование на всех этапах.

🌱 Работаю с Jira, TestIT, Git, DevTools, Postman, Swagger, Charles, SQL; понимаю клиент-серверную архитектуру, техники тест-дизайна, протоколы TCP, HTTP\HTTPS. Составляю чек-листы, оформляю тест-кейсы в TestIT и баг-репорты в Jira. 

🤖 Осваиваю автоматизацию тестирования на pet-проекте с применением LLM-агентов в Cursor.

<h2>Что я умею тестировать</h2>

- Web-приложения — формы и валидации, авторизация и роли доступа, личные кабинеты, каталоги, корзины, оформление заказов, админки CMS
- API — REST и SOAP: коды ответов, структура и данные в теле, негативные сценарии; сверка с документацией Swagger/OpenAPI
- Базы данных — проверка данных в БД после действий в UI и API-запросов через SQL-запросы
- UI/UX — соответствие макетам (Figma, Adobe XD), адаптивность, кроссбраузерность
- Локализация дефектов — поиск причины бага через DevTools (Console, Network), логи и данные в БД
- Регресс — перед релизами и после доработок, обновлений и переносов: убеждаюсь, что изменения не сломали существующий функционал
- Smoke после деплоя — быстрая проверка ключевых сценариев на проде, что релиз прошёл штатно
- Mobile web и Android — проверки в эмуляторе Android Studio
- Перехват трафика и подмена запросов через Charles Proxy: HTTPS-перехват, Rewrite, Map Remote/Local — для отладки и воспроизведения багов
...
<p>
  <a href="https://developer.chrome.com/docs/devtools/" target="_blank"><img src="https://d33wubrfki0l68.cloudfront.net/38b5c953a4667366685d55db55d057c86db1fc54/a0fdc/static/acae6b24d940347661ca901ea07f47c1/chrome-dev-logo-icon.png" title="Chrome DevTools" alt="Chrome DevTools" width="40"/></a>&nbsp;
  <a href="https://www.postman.com/" target="_blank"><img src="https://www.svgrepo.com/show/354202/postman-icon.svg" title="Postman" alt="Postman" width="40"/></a>&nbsp;
...
<p>
  <a href="https://git-scm.com/" target="_blank"><img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg" title="Git" alt="Git" width="40"/></a>&nbsp;
