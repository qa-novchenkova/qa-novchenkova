...
⚡QA Engineer с 16+ годами в IT и сильным бэкграундом в веб-разработке. Участвовала в полном цикле web-проектов (требования, вёрстка, сборка на CMS, релиз, поддержка); 
