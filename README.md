...
⚡7 лет опыта в заказной web-разработке. Участвовала в полном цикле создания web-проектов: требования, вёрстка, сборка на CMS, релиз, поддержка, тестирование на всех этапах.
