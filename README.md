...
- Регресс — перед релизами и после доработок, обновлений CMS и переносов: убеждаюсь, что изменения не сломали существующий функционал
- Smoke после деплоя — быстрая проверка ключевых сценариев на проде, что релиз прошёл штатно
- Mobile web и Android — проверки в эмуляторе Android Studio, перехват трафика мобильных приложений через Charles Proxy
