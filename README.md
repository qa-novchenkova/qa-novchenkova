...
⚡QA Engineer с 16+ лет опыта в IT, из них 7 лет — в digital-агентстве заказной разработки. Участвовала в полном цикле создания web-проектов (требования, вёрстка, сборка на CMS, релиз, поддержка); 

🌱 Тестирую web, API и mobile, работаю с SQL, Postman, Charles Proxy, составляю чек-листы, оформляю тест-кейсы в TestIT и баг-репорты в Jira. Понимаю клиент-серверную архитектуру и говорю с разработчиками на одном языке. 

🤖 Постепенно погружаюсь в автоматизацию тестирования (Python, Selenium, pytest, Allure) и мониторинг (Elasticsearch, Kibana, Docker). Использую AI-агентов (Cursor) в QA-задачах: генерация автотестов, тестовых данных, чек-листов, анализ баг-репортов и подготовка документации.
